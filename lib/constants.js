...
// ══════════════════════════════════════════════════════════
// WITHDRAW — impression/CPM based (this rebuild). A user types a DC amount
...
//
// ⚠️ WEEKLY-FRIDAY-ONLY submission window — admin has explicitly asked to
// ADD THIS LATER (still testing withdraw end-to-end right now; a real
// once-a-week lock would block that testing). WITHDRAWALS_OPEN below stays
// as the existing manual admin on/off switch for now — nothing
// Friday-specific has been added yet. Revisit lib/dailyReset.js-style logic
// for this once admin confirms testing is done.
// ══════════════════════════════════════════════════════════
export const MIN_WITHDRAW_IMPRESSIONS = 500;                                    // minimum impressions per withdraw request
export const MIN_WITHDRAW_DC = MIN_WITHDRAW_IMPRESSIONS * DC_PER_IMPRESSION;    // = 25,000 DC
